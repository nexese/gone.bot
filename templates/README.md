...
These Markdown files are starting points for a user acting for themself. Select the template that matches the strongest reviewed control available for the user's goal:

- [`deletion-request.md`](deletion-request.md)
- [`opt-out-request.md`](opt-out-request.md)
- [`freeze-request.md`](freeze-request.md)
