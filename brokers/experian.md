...
- `freeze` — restrict most new-credit access to the Experian credit file when deletion is unavailable. This does not erase the file and has legal access exceptions.
...
- Destination: Experian's official freeze page
...
An Experian confirmation proves only Experian's reported freeze status, not deletion or a freeze at another bureau or Experian-owned specialty company.

## Limitations

- Separate freezes may be needed for Clarity Services and other specialty reports.
