...
Personal data eraser for agent-enabled desktop clients.

GoneBot is an AI agent that helps reduce how data brokers expose your personal information. It seeks deletion first, then uses the strongest available suppression, opt-out, block, or security freeze when deletion is unavailable. ChatGPT desktop or Claude Code prepares and submits each request with your approval and tracks what happens next. GoneBot is free, runs through your desktop client, and uses that client's connectors on your behalf.

## Getting started

Use this prompt in [ChatGPT desktop](https://chatgpt.com/download/) or [Claude Code in the desktop app](https://claude.com/download):
